...
test("Verify Error Handling for Mandatory Checkout Fields",async({page}) =>{
    ...
    await expect(test_checkoutPage.validationErrorMessages).toBeVisible();
    await expect(test_checkoutPage.validationErrorMessages).toContainText("Billing Street address");
});